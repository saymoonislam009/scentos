    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <form action={signUp} className="glass rounded-2xl p-8 space-y-4">
          ...
          <div><label className="mb-1.5 block font-mono text-2xs uppercase tracking-wider text-ash">Password</label><input name="password" type="password" required minLength={8} autoComplete="new-password" className="input" placeholder="Min 8 characters"/></div>
